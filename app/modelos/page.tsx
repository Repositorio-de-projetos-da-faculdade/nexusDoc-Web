  ...
  return (
    <div className="flex flex-col h-full bg-[var(--background)]">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {isLoading ? (
          <div className="text-sm text-[var(--muted-foreground)]">Carregando modelos…</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link
              href="/modelos/novo"
              className="border-2 border-dashed border-[var(--border)] rounded-[var(--radius)] p-5 flex flex-col items-center justify-center text-[var(--muted-foreground)] hover:text-[var(--primary)] hover:border-[var(--primary)] transition-colors duration-200 cursor-pointer min-h-[200px]"
            >
